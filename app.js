document.addEventListener("DOMContentLoaded", () => {
  ...
  const CARDS = [
    ...
    { id:13,nombre:"Mayichi (1K)",tipo:"presidenta",imagen:"https://i.ibb.co/0p9Js9tm/14-Amablitz.png"},
    { id:14,nombre:"Ama Blitz (Aniquiladoras FC)",tipo:"presidenta",imagen:"https://i.ibb.co/MDN445S2/13-Mayichi.png"},
